...
import { PokemonMapper } from './pokemon-maper';

export const mockApiResponse: PokemonResponse = {
  abilities: [
    {
      ability: {
        name: 'static',
...
describe('PokemonMapper', () => {
  it('should map a complete PokemonResponse to Pokemon correctly', () => {
    // Arrange

    // Act
    const result = PokemonMapper.toPokemon(mockApiResponse);
  ...
  // it('should handle abilities with [] ', () => {
  //   // Arrange
  //   const mokApiForAbilities = { ...mockApiResponse };
  //   mokApiForAbilities.abilities = [];
  //   // Act
  //   const result = PokemonMapper.toPokemon(mokApiForAbilities);
  ...
  // it('should urlImage equal a "" ', () => {
  //   // Arrange

  //   const mokApiForImg = { ...mockApiResponse };
  //   mokApiForImg.sprites.other!['official-artwork'].front_default = undefined!;
  //   // Act
  //   const result = PokemonMapper.toPokemon(mokApiForImg);
  ...
  // it('should handle missing cries with null ', () => {
  //   // Arrange

  //   const mokApiForCries = { ...mockApiResponse };
  //   mokApiForCries.cries = {
  //     latest: null!,
  //     legacy: '',
  //   };
  //   // Act
  //   const result = PokemonMapper.toPokemon(mokApiForCries);
